...
class WeConnectId:
    ...
    def _sign_in(self):
        ...
        r = self.session.get('https://login.apps.emea.vwapps.io/authorize?nonce=' + nonce + '&redirect_uri=weconnect://authenticated')
    ...
    def get(self, endpoint):
        return self.session.get(BASE_URL + endpoint).json()